...
Soy **Analista de Software** cursando la carrera de **Computación e Informática**, próximo a concluirla. Me caracterizo por ser una persona **comprometida** y **apasionada por los desafíos tecnológicos**, siempre buscando soluciones innovadoras y eficientes.

### 🔭 Proyecto Actual
Actualmente estoy desarrollando **Olyxis**, un framework PHP que implementa el patrón arquitectónico **MVC (Model-View-Controller)**, diseñado para optimizar el desarrollo de aplicaciones web robustas y escalables.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Conectar-0077B5?style=for-the-badge&logo=linkedin)](https://www.linkedin.com/in/javier-jeanpool-borja-samaniego-a6b8b7300/)
